...
func StartNewOrOldParty(ctx context.Context, mpcCtxIndexArr []int32, preParam *keygen.LocalPreParams, sk keygen.LocalPartySaveData, gid string, partyIndex int, isOld bool, partyCount int, threshold int, nPartyCount int, nThreshold int, sendMsg func(tss.ParsedMessage, string) error) (tss.Party, chan keygen.LocalPartySaveData) {
